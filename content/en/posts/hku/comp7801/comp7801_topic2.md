...
![point_access_methods](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/point_access_methods.png)
...
![object_clipping](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/object_clipping.png)

**Optimization**
- Group the objects below into 3 groups of 4 objects each such that the MBRs of the groups have the minimum overlap

![overlap_region](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/overlap_region.png)
...
![R_Tree_example](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/R_Tree_example.png)
...
![range_search](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/range_search.png)
...
![margin_minimization](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/margin_minimization.png)
...
- Insertion heuristics (Select the path)
  ...
  ![MBR_enlargement](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/MBR_enlargement.png)
  - Least MBR overlap after insertion
  ![MBR_overlap](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/MBR_overlap.png)
...
![forced_reinsert](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/forced_reinsert.png)
...
![bulk_loading_R_tree](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/bulk_loading_R_tree.png)
...
![distance_mbr](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/distance_mbr.png)

Distances between R-tree node MBRs lower-bound the distances between the entries in them

![min_distance_mbr](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/min_distance_mbr.png)
...
![q_distance_mbr](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/q_distance_mbr.png)
...
![DFNNS_code](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/DFNNS_code.png)
...
![DFNNS_example](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/DFNNS_example.png)
...
![BFNNS_code](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/BFNNS_code.png)
...
![BFNNS_example](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/BFNNS_example.png)
...
![R_tree_join_code](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/R_tree_join_code.png)
...
![R_tree_join_example](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/R_tree_join_example.png)
...
![R_tree_join_optimization](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/R_tree_join_optimization.png)
...
![R_tree_join_optimization2](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/R_tree_join_optimization2.png)
...
![spatial_hash_join](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/spatial_hash_join.png)

**Partition based spatial merge join**

![spatial_merge_join](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/spatial_merge_join.png)

**Indexed Nested Loops**

![indexed_nest_loops](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/indexed_nest_loops.png)

**Seeded tree join and Bulk-load and Match build an on-the-fly R-tree**

![seeded_tree_join](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/seeded_tree_join.png)

**Slot-index spatial join applies hash-join using the entries of a high R-tree level**

![slot_index_spatial_join](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/slot_index_spatial_join.png)

### The refinement step

![refinement_step](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/refinement_step.png)
...
![refinement_detailed_approximations](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/refinement_detailed_approximations.png)
...
![refinement_multi_step](https://pseudoyu.oss-cn-hangzhou.aliyuncs.com/images/refinement_multi_step.png)
