...
由于 Railway 在 8.1 正式关闭了，n8n 同步系统停了两天，调研了一番后来还是在自己的 vps 上用 docker 运行了（一台搬瓦工的 ThePlan，2c2g，配合 NginxProxyManager 进行反向代理，跑了我大部分需要数据持久化的服务），顺便更新了一下版本，继续进行同步啦。
