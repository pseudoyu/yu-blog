...
![sockets](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/sockets.png)
...
![transport_service](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/transport_service.png)
...
![transport_protocols](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/transport_protocols.png)
...
![ssl_tls](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/ssl_tls.png)

**The IP Hourglass**

![ip_hourglass](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/ip_hourglass.png)
...
* Request
  ...
  * ![http_request](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/http_request.png)
  * Methods
    * POST
    * GET
    * HEAD
    * PUT
* Response
  * ![http_response](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/http_response.png)
  * Statu Code
    * Informational, 1XX
...
* Example
  * ![cookie_example](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/cookie_example.png)
* 3rd-party cookies
  ...
  * ![3_party_cookies](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/3_party_cookies.png)
...
![conditional_get](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/conditional_get.png)
...
* Example
  * ![smtp_example](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/smtp_example.png)
...
* ![mail_mime](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/mail_mime.png)

**Mail Access Protocols**

![mail_access_protocols](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/mail_access_protocols.png)
...
* DNS services
  ...
  * Load distribution
* ![dns_services](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/dns_services.png)
* Root Name Servers
  * ![root_name_servers](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/root_name_servers.png)
...
* DNS query and reply messages, both with same message format
  ...
  * ![dns_message](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/dns_message.png)
...
![client_server_file](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/client_server_file.png)
...
![p2p_cs](https://cdn.jsdelivr.net/gh/pseudoyu/image_hosting@master/hugo_images/p2p_cs.png)
