---
title: "基于 yabai 和 skhd 的 macOS 窗口管理系统"
...
从 2017 年暑假攒钱买了第一台 Macbook Pro 开始，我使用 macOS 已经五年了。因为工作学习需要，也逐渐开始使用多屏工作流，因为随时都需要开很多窗口，如 IDE、文本编辑工具、终端、IM 软件、邮件客户端等，稍没注意就很乱，需要不停地切换来找到需要的窗口，很不方便，于是开始了自己的窗口管理方案探索之路。

## 窗口管理工具

市面上也有很多窗口管理工具，比如 [Magnet](https://magnet.crowdcafe.com)、[BetterTouchTool 附带的窗口吸附功能](https://docs.folivora.ai/docs/100_window_snapping_chapter.html)等，我都有购买使用，但总体来说都不怎么满意。

Magnet 主要依赖于快捷键，尽管可以自己定制符合习惯的快捷键，但记忆成本很高，且如果有多台设备也需要用自己的帐号下载后重新配置才可以继续使用，并不方便。

![magnet_keyshotcuts](https://cdn.jsdelivr.net/gh/pseudoyu/image-hosting@master/images/magnet_keyshotcuts.png)
...
![bettertouchtool_setting](https://cdn.jsdelivr.net/gh/pseudoyu/image-hosting@master/images/bettertouchtool_setting.png)

## 窗口管理方案需求

其他方案了解了一下也大同小异，总是觉得不太适合自己的工作流。于是我开始梳理自己的窗口管理需求，列出了以下几个核心要点：
...
既然既有的软件都没无法完全满足我的需求，作为一个爱折腾的程序员，目标转向了开源社区一些可高度定制化的解决方案。
...
![see_user_and_config_yabai_sudo](https://cdn.jsdelivr.net/gh/pseudoyu/image-hosting@master/images/see_user_and_config_yabai_sudo.png)
...
![my_layout_1](https://cdn.jsdelivr.net/gh/pseudoyu/image-hosting@master/images/my_layout_1.png)
...
![keyboardshortcut_to_change_desktop](https://cdn.jsdelivr.net/gh/pseudoyu/image-hosting@master/images/keyboardshortcut_to_change_desktop.png)
...
![reduce_display_effect](https://cdn.jsdelivr.net/gh/pseudoyu/image-hosting@master/images/reduce_display_effect.png)
